...
M.set = function(colors, _opts)
  highlight("Normal", { fg = colors.interface.foreground, bg = colors.interface.background })
  ...
  highlight("Directory", { fg = colors.syntax.info, bg = colors.interface.background })
  highlight("DiffAdd", { fg = "NONE", bg = colors.success })
  ...
  highlight("EndOfBuffer", { fg = colors.interface.background, bg = "NONE" })
  highlight("ErrorMsg", { fg = colors.interface.error, bg = colors.interface.background })
  ...
  highlight("FoldColumn", { fg = colors.interface.foreground, bg = colors.interface.background })
  highlight("SignColumn", { fg = "NONE", bg = colors.interface.background })
  highlight("IncSearch", { fg = "NONE", bg = colors.accent })
  highlight("LineNr", { fg = colors.interface.border, bg = colors.interface.background })
  highlight("CursorLineNr", { fg = colors.syntax.info, bg = colors.interface.background })
  highlight("MatchParen", { fg = "NONE", bg = colors.hint })
  highlight("ModeMsg", { fg = colors.interface.foreground, bg = colors.interface.border })
  highlight("MoreMsg", { fg = colors.interface.foreground, bg = colors.interface.border })
  highlight("NonText", { fg = colors.interface.border, bg = "NONE" })
  highlight("Pmenu", { fg = colors.interface.foreground, bg = colors.interface.border })
  highlight("PmenuSel", { fg = "NONE", bg = colors.accent })
  highlight("PmenuSbar", { bg = colors.interface.background })
  highlight("PmenuThumb", { fg = colors.interface.border, bg = colors.interface.border })
  highlight("Question", { fg = colors.syntax.info, bg = colors.interface.background })
  highlight("Search", { fg = "NONE", bg = colors.accent })
  highlight("SpecialKey", { fg = colors.syntax.info, bg = "NONE" })
  highlight("StatusLine", { fg = colors.interface.foreground, bg = colors.interface.border })
  highlight("StatusLineNC", { fg = colors.interface.foreground, bg = colors.interface.border })
  highlight("TabLine", { fg = colors.interface.foreground, bg = colors.interface.border })
  highlight("TabLineFill", { fg = colors.interface.foreground, bg = colors.interface.background })
  highlight("TabLineSel", { fg = colors.interface.foreground, bg = colors.interface.selection })
  highlight("Title", { fg = colors.interface.foreground, bg = "NONE", bold = true })
  highlight("Visual", { fg = "NONE", bg = colors.interface.selection })
  highlight("VisualNOS", { fg = "NONE", bg = colors.interface.selection })
  highlight("WarningMsg", { fg = colors.interface.warning, bg = colors.interface.background, bold = true })
  ...
  highlight("Operator", { fg = colors.interface.foreground, bg = "NONE" })
  ...
  highlight("SpecialChar", { fg = colors.interface.foreground, bg = "NONE" })
  highlight("Tag", { fg = colors.interface.foreground, bg = "NONE" })
  highlight("Delimiter", { fg = colors.interface.foreground, bg = "NONE" })
  highlight("SpecialComment", { fg = colors.syntax.comment, bg = "NONE" })
  highlight("Debug", { fg = colors.interface.foreground, bg = "NONE" })
  highlight("Underlined", { fg = "NONE", bg = "NONE", underline = true })
  highlight("Conceal", { fg = colors.interface.foreground, bg = colors.interface.background })
  highlight("Ignore", { fg = colors.interface.foreground, bg = "NONE" })
  highlight(
    "Error",
    { fg = colors.interface.error, bg = colors.interface.background, undercurl = true, sp = colors.interface.error }
  )
  highlight("Todo", { fg = colors.interface.warning, bg = colors.interface.background, bold = true })
  ...
  highlight("SpellLocal", { fg = "NONE", undercurl = true, sp = colors.info })
  highlight("Whitespace", { fg = colors.syntax.comment })

  -- Floating and window bar
  highlight("NormalFloat", { bg = colors.interface.background })
  highlight("FloatBorder", { fg = colors.interface.border })
  highlight("WinBar", { fg = colors.interface.foreground, bg = colors.interface.background, bold = true })
  highlight("WinBarNc", { fg = colors.interface.foreground, bg = colors.interface.background })
  ...
  highlight("@punctuation.bracket", { fg = colors.interface.foreground, bg = "NONE" })
  highlight("@punctuation.special", { fg = colors.interface.foreground, bg = "NONE" })
  highlight("@punctuation.delimiter", { fg = colors.interface.foreground, bg = "NONE" })
  ...
  highlight("markdownCodeDelimiter", { fg = colors.interface.foreground, bg = "NONE" })
  ...
  highlight("markdownUrl", { fg = colors.interface.foreground, bg = "NONE", underline = true })
  ...
  highlight("@text", { fg = colors.interface.foreground, bg = "NONE" })
  highlight("@markup.strong", { fg = colors.intent.hint, bg = "NONE", bold = true })
  highlight("@markup.italic", { fg = colors.interface.foreground, bg = "NONE", italic = true })
  highlight("@markup.underline", { fg = colors.interface.warning, bg = "NONE", underline = true })
  highlight("@markup.strikethrough", { fg = colors.interface.foreground, bg = "NONE", strikethrough = true })
  highlight("@markup.heading", { fg = colors.intent.hint, bg = "NONE", bold = true })
  highlight("@markup.raw", { fg = colors.interface.foreground, bg = "NONE" })
  ...
  highlight("@markup.link.url", { fg = colors.interface.foreground, bg = "NONE" })
